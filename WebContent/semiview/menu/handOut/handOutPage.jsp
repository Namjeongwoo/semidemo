...
<body>
	<div class="layer" id="wrap">
            ...
            <!-- view.do? == 상세보기 -->
               ...
               <tr>
                  <td colspan="4">
                  	...
                  	<img style="border: 1px solid black;"  src="../semiview/images/handout/${dto.main_picture}"/>
                  	</a>
				  </td>
			   </tr>
			   <tr>
      ...
      <c:if test="${requestScope.pdto.startPage > 1 }">
         <span><a class = "aPage" href = "handOut.do?pageNum=${pdto.startPage-pdto.blockPage }">이전</a></span>
      </c:if>
      ...
      <c:if test="${requestScope.pdto.endPage < requestScope.pdto.totalPage }">
         <span><a class = "aPage" href="handOut.do?pageNum=${pdto.startPage+pdto.blockPage }">다음</a></span>
      </c:if>
	  		</div>
			</div>
		</div>
